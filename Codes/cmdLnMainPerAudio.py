...
"""
"""
Function to run the featuresAndLabelsNoSplitPerAudio.py from the command prompt.
"""
import sys

import featuresAndLabelsNoSplitPerAudio
...
def main():
    ...
    for audioIndex in range(0,len(audioFiles)):
        ...
        features, labels=\
        featuresAndLabelsNoSplitPerAudio.featuresAndLabels(\

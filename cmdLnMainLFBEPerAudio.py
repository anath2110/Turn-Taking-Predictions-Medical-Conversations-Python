...
"""
"""
Function to run the featuresLFBEAndLabelsNoSplitPerAudio.py from the command prompt.
"""
import sys

import featuresLFBEAndLabelsNoSplitPerAudio
...
def main():
    ...
    for audioIndex in range(0,len(audioFiles)):
        ...
        features, labels=\
        featuresLFBEAndLabelsNoSplitPerAudio.featuresAndLabels(\
